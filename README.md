...
[![GoDoc](https://godoc.org/github.com/L-four/api2go?status.svg)](https://godoc.org/github.com/L-four/api2go)
...
```go
go get github.com/L-four/api2go
```
...
- Basic Examples can be found [here](https://github.com/L-four/api2go/blob/master/examples/crud_example.go).
...
can directly use our sub-package `github.com/L-four/api2go/jsonapi`
...
```go get -tags=gingonic github.com/L-four/api2go```
